...
export const cards: card[] = [
    {
        name: "Traveler",
        description: "A traveler from another world who had their only kin taken away, forcing them to embark on a journey to find The Seven.", /* gotta think about this  */
        power: 5000, /* think about this later */
        leader: true, /* think about this later too */
        card_type: "Physical", //for now, will change in battle
        card_image: "string",
    ...
    },
    {
        ...
        card_type: "Wind",
        card_image: "string",
        stars: 3000, /* think about thise later too^2 */
        game: "Genshin Impact",
        region: "Inazuma, teyvat",
    },
    {
